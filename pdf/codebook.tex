...
\includecode{ManhattanMST}{../code/Graph/ManhattanMST.cpp}
\includecode{TreeHash}{../code/Graph/TreeHash.cpp}
\includecode{MaximumIndependentSet}{../code/Graph/MaximumIndependentSet.cpp}
\includecode{MinMeanWeightCycle}{../code/Graph/MinMeanWeightCycle.cpp}
...
\includecode{Convex Hull trick}{../code/Geometry/ConvexHull.cpp}
