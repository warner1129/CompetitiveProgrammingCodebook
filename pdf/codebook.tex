...
\includecode{IO}{../code/Basic/io.cpp}
\newpage
\includecodeX[language=vim]{vimrc}{../code/Basic/vimrc}
\includecodeX[language=make]{Makefile}{../code/Basic/Makefile}
...
\includecodehash[]{Global Min Cut}{../code/Flow/GlobalMinCut.cpp}
...
\includecodehash[]{Bostan Mori}{../code/Math/BostanMori.cpp}
...
\includecodehash[]{Union of Polygons}{../code/Geometry/UnionOfWeightPolygons.cpp}
...
% \includecodehash[]{SAIS}{../code/String/SuffixArray-SAIS.cpp}
...
\includecodehash[]{RunEnumerate}{../code/String/RunEnumerate.cpp}
\includecodehash[]{Rolling Hash}{../code/String/RollingHash.cpp}
...
% \includecodeX[language=java]{Java}{../code/Misc/example.java}
